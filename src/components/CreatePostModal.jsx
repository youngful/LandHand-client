...
function CreatePostModal({ isOpen, onClose }) {
	...
	return (
		<div className='fixed top-0 left-0 w-full h-full bg-[rgba(0,0,0,0.5)] z-50 overflow-auto'>
				<div className='absolute bg-[#E5E5E5] top-[100px] left-1/2 transform -translate-x-1/2 p-8 rounded-[48px] max-w-[600px] w-full'>
